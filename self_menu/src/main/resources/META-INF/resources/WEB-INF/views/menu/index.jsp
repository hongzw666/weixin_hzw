...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/hzw/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/hzw/menu/js/jquery.js"></script>
<script type="text/javascript" src="/hzw/menu/js/vue.js"></script>
<script type="text/javascript" src="/hzw/menu/js/menu.js"></script>
